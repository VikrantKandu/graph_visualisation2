...
import '../Style_css/Graph.css'; // Graph styles
import lbImage from '../pic/lb.png'; // Image path
// import GraphAnimation from '../GraphAnimation'; // Import GraphAnimation component
...
const Cloud_Function = () => {
  ...
  return (
    <div className="graph-container">
      ...
      {/* Modal for displaying node info */}
      {isModalOpen && selectedNode && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button onClick={handleAnimationClick}>Start Animation</button>
          </div>
        </div>
      )}

      {/* Trigger animation when animationData is set */}
      {animationData && <GraphAnimation data={animationData} />}
    </div>
  );
};
